...
class ViewEmployeeComponent extends Component {
    ...
    render() {
        return (
            <div>
                <div class="btn-group">
                <button className="btn btn-primary active"  onClick={ () => this.viewEmployee(this.state.employee.id)}> Information</button>
                <button className="btn btn-primary"  onClick={ () => this.workingEmployee(this.state.employee.id)}> Working</button>
                        ...
                        <thead>
                            ...
                            <tbody>
                                        ...
                                        <tr>
                                             ...
                                             <td> {this.state.employee.team}</td>
                                             <td> {this.state.employee.moneyPerHour}</td>
                                             <td>
